...
def dubins_main(pt1,pt2,turning_rad):
    # User's waypoints: [x, y, heading (degrees)]
    pt1 = Waypoint(pt1[0],pt1[1],pt1[2])
    pt2 = Waypoint(pt2[0],pt2[1],pt2[2])
    ...
    i = 0
    while i<len(Wptz)-1:
        param = calcDubinsPath(Wptz[i], Wptz[i+1], turning_rad)
...
# dubins_main((20.275376956736586, 90.0, 45.00000000000002),(30.275376956736586, 90.0, 45.00000000000002),10)
